...
<body>
    <div class="container">
        ...
        <div> <ul>
                ...
                <li> On pourrait aussi complètement supprimer le routeur et remplacer le fichier actuel index par le fichier viewAccueil, puis passer de vue en vue en mettant en ction les différents controlleurs.</li>
