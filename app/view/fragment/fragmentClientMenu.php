        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="router1.php?action=residenceReadAllClient">Liste de mes résidences</a></li>
                        <li><a class="dropdown-item" href="router1.php?action=residenceReadAllOther">Achat d'une nouvelle résidence</a></li>           
                    </ul>
                <li class="nav-item dropdown">
